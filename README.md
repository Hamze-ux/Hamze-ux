...
**Data:** SQL Server, Firebase Firestore  
...
- React + Vite frontend with Arabic/English localization
- ASP.NET Core Web API backend
- Automated RSS pipeline with OpenAI analysis (auto-publish/reject + email reports)
- Cloudinary image management, SQL Server database

### Shahiya
A recipe management system (Android + Web admin panel). Final graduation project, graded 100%.
